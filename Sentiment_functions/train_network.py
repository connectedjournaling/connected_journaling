...
storage_location = Path("/Users/petergramaglia/Documents/GitHub/new_connected/connected_journaling/data/tweets_shuffled_tiny.csv")
storage_location = Path("/Users/petergramaglia/Documents/GitHub/new_connected/connected_journaling/data/combined_tiny.csv")
...
print("Reading csv")
dataset = pd.read_csv(storage_location, engine='python')
